...
function saveRatingsToRemoteServer(wineryID,wine_id,ratings,callback,error_callback){
	...
	$.post('https://hdl2fzrybi.execute-api.us-west-1.amazonaws.com/bestcoast/products/ratings/',{id:wine_id,ratings:ratings,vendor_id:wineryID,uuid:device.uuid},function(json){
...
function updateRatingsToRemoteServer(id,ratings,callback,error_callback){ 
	...
	$.ajax({
         type: "PUT",
         url:"https://hdl2fzrybi.execute-api.us-west-1.amazonaws.com/bestcoast/products/ratings/",
         data:put_data,
         beforeSend: function(){ },
